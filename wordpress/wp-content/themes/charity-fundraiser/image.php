...
<div class="container">
    <main id="maincontent" role="main" class="main-wrap-box py-4">
        ...
        if($charity_fundraiser_left_right == 'Left Sidebar'){ ?>
            <div class="row">
                ...
                <div class="col-lg-9 col-md-8" id="wrapper">
                    <?php while ( have_posts() ) : the_post(); ?>    
                        <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                            ...
                            <?php edit_post_link( __( 'Edit', 'charity-fundraiser' ), '<footer role="contentinfo" class="entry-meta"><span class="edit-link">', '</span></footer>' ); ?>
                        </article>    
                        <?php
        ...
        <?php }else if($charity_fundraiser_left_right == 'Right Sidebar'){ ?>
            <div class="row">
                <div class="col-lg-9 col-md-8" id="wrapper">
                    <?php while ( have_posts() ) : the_post(); ?>    
                        <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
        ...
        <?php }else if($charity_fundraiser_left_right == 'Three Columns'){ ?>
            <div class="row">
                ...
                <div class="col-lg-6 col-md-4" id="wrapper">
                    <?php while ( have_posts() ) : the_post(); ?>    
                        <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                            <div class="entry-content">
                                <h1><?php esc_html(the_title()); ?></h1>    
