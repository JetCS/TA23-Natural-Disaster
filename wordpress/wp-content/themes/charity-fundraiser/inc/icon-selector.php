...
class Charity_Fundraiser_Icon_Selector extends WP_Customize_Control{
      public $type = 'icon';
            ...
            <label>
                  ...
                  <ul class="icon-list">
                      <div class="social-icon-search">
                          <input class="socialInput" type="text" placeholder="<?php echo esc_attr('Search Icon', 'charity-fundraiser'); ?>">
                      </div>
                    <?php
                    $charity_fundraiser_font_awesome_icon_array = charity_fundraiser_font_awesome_icon_array();
                    foreach ($charity_fundraiser_font_awesome_icon_array as $charity_fundraiser_font_awesome_icon) {
                            $icon_class = $this->value() == $charity_fundraiser_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($charity_fundraiser_font_awesome_icon).'"></i>
                            <span class="charity-fundraiser-social-class">'.esc_attr($charity_fundraiser_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                  </ul>
...
function charity_fundraiser_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/css/fontawesome-all.css');
}
add_action( 'customize_controls_enqueue_scripts', 'charity_fundraiser_customizer_script' );

if(!function_exists('charity_fundraiser_font_awesome_icon_array')){
    function charity_fundraiser_font_awesome_icon_array(){
