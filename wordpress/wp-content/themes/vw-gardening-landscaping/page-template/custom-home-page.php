...
<main id="maincontent" role="main">
              ...
              <div class="carousel-caption">
                <div class="inner_carousel">
                  ...
                  <?php if( get_theme_mod('vw_gardening_landscaping_slider_content_hide_show',true) != ''){ ?>
                    <p class="wow rollIn" data-wow-duration="3s"><?php $excerpt = get_the_excerpt(); echo esc_html( vw_gardening_landscaping_string_limit_words( $excerpt, esc_attr(get_theme_mod('vw_gardening_landscaping_slider_excerpt_number','30')))); ?></p>
                  <?php } ?>
  ...
  <section id="serv-section" class="wow zoomInDown delay-1000">
    <div class="container">
