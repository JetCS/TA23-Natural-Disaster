...
function vw_gardening_landscaping_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting( 'vw_gardening_landscaping_hide_show_footer_credit_link',array(
    	'default' => 1,
      	'transport' => 'refresh',
      	'sanitize_callback' => 'vw_gardening_landscaping_switch_sanitization'
    ));  
    $wp_customize->add_control( new VW_Gardening_Landscaping_Toggle_Switch_Custom_Control( $wp_customize, 'vw_gardening_landscaping_hide_show_footer_credit_link',array(
      	'label' => esc_html__( 'Footer Credit Link','vw-gardening-landscaping' ),
      	'section' => 'vw_gardening_landscaping_footer'
    )));
