...
<div class="post-author">
	...
	<p class="align-right"><i class="fas fa-comments"></i> &nbsp;<a class="scroll" href="<?php the_permalink(); ?>#comments"><?php comments_number( esc_html__("Leave a Comment", 'natural-lite'), esc_html__("1 Comment", 'natural-lite'), '% Comments'); ?></a></p>
</div>
