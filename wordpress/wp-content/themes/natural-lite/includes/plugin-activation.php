 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme Natural Lite
...
add_action( 'tgmpa_register', 'natural_lite_register_required_plugins' );
 ...
 */
function natural_lite_register_required_plugins() {
	/*
	 ...
	 */
	$config = array(
		'id'           => 'natural-lite',                 // Unique ID for hashing notices for multiple instances of TGMPA.
