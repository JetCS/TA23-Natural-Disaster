					...
					<?php
						...
						while ( have_posts() ) : the_post(); 
							...
							the_post_navigation( array(
								'prev_text' => '<span class="screen-reader-text">' . __( 'Previous Post', 'shams-solar' ) . '</span><span aria-hidden="true" class="nav-subtitle text-uppercase">' . __( 'Previous', 'shams-solar' ) . '</span>',
								'next_text' => '<span class="screen-reader-text">' . __( 'Next Post', 'shams-solar' ) . '</span><span aria-hidden="true" class="nav-subtitle text-uppercase">' . __( 'Next', 'shams-solar' ) . '</span>',
							) );
						}
