...
= 0.6.2 =
* Added icon changer option for scroll to top.
...
* Resolved Css error.
* Updated arabic, spanish, german, chinese and french languages PO file.
...
Shams Solar WordPress Theme, Copyright 2019 ThemesEye
Shams Solar is distributed under the terms of the GNU GPL
...
Shams Solar WordPress Theme is derived from Twenty Seventeen WordPress Theme, Copyright 2016 WordPress.org
Twenty Seventeen WordPress Theme is distributed under the terms of the GNU GPL

Shams Solar bundles the following third-party resources:
...
** Screenshot Images
    ...
    License: CC0 1.0 Universal (CC0 1.0)
    Source: https://stocksnap.io/photo/M3WRIJL64I 

    Post image, Copyright Startup Stock Photos
    License: CC0 1.0 Universal (CC0 1.0)
    Source: https://stocksnap.io/photo/NQQ2PJW1JM
