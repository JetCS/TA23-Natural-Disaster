    ...
    public function enqueue_scripts($hook_suffix){
        ...
        */
        ...
        wp_localize_script( $this->plugin_name, 'quizLangObj', array(
            ...
            'minimumCountQuestionShouldBe2'  => __( "You must select at least one correct answer", $this->plugin_name ),
            'minimumCountQuestionShouldBe2'  => __( "Sorry, you must fill out all answer fields.", $this->plugin_name ),
...
//            echo "cURL Error #:" . $err;
	...
	public function ays_get_active_camp_data( $data, $url, $api_key ) {
		...
		curl_setopt_array($curl, array(
			CURLOPT_URL            => "$url/api/3/$data?limit=100",
			CURLOPT_RETURNTRANSFER => true,
			CURLOPT_ENCODING       => "",
			CURLOPT_MAXREDIRS      => 10,
			CURLOPT_TIMEOUT        => 30,
