	...
	class PageTemplatesDirectory {
		...
		public function gutenberg_templates_list() {
			...
			'sktsandwich-gutenberg'              => array(
					...
					'keywords'    => __( ' Gutenberg, gutenberg, bakery, burgers, cheeseburger, fast food, meal, menu, pizza, restaurant, salad, sandwich, bar, bistro, cafeteria, food, food shop, online food, Online Pizza, pizza builder, pizza restaurant, pizza shop, pizzeria, beverages' ),
			),			
